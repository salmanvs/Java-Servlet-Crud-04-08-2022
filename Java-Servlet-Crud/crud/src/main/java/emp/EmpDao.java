	...
	public static Connection getConnection() {
	 ...
	 public static int save(Emp e){  
	        ...
	        try{  
	            ...
	            PreparedStatement ps=con.prepareStatement("insert into employee_details(name,password,email,country) values (?,?,?,?)");  
	    ...
	    public static int update(Emp e){  
	        ...
	        try{  
	            ...
	            PreparedStatement ps=con.prepareStatement(  
	                         "update employee_details set name=?,password=?,email=?,country=? where id=?");  
	            ps.setString(1,e.getName());  
	            ps.setString(2,e.getPassword());  
	            ps.setString(3,e.getEmail());  
	            ps.setString(4,e.getCountry());  
	    ...
	    public static Emp getEmployeeById(int id){  
	        ...
	        try{  
	            Connection con=EmpDao.getConnection();  
	            PreparedStatement ps=con.prepareStatement("select * from employee_details where id=?");  
	            ps.setInt(1,id);  
